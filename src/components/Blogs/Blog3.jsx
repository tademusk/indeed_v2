...
import kids from '../../assets/senae.jpg'
...
const Blog3 = () => {
  return (
      <motion.div
          ...
          className='blogs-buttom grid lg:grid-cols-2  mt-8 text-white rounded-[15px] bg-nahom h-[60%]'>
          <div className="bt-left flex flex-col gap-10  p-14">
            <h1 className=' text-2xl font-bold text-center'>Read daily and make you perfect</h1>
          ...
          <div className="bt-right p-14 flex flex-col justify-center">
            <img className='rounded-[15px]' src={kids} alt="kids" />
          </div>
        </motion.div>
    )
  }
