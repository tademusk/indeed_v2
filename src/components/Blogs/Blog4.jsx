...
import animals from '../../assets/senae.jpg'
...
const Blog4 = () => {
  return (
    <motion.div
        ...
        className='blogs-buttom grid lg:grid-cols-2 mt-8 text-white rounded-[15px] bg-kalab h-[60%]'>
        <div className="bt-left flex flex-col gap-10  p-14">
          <h1 className=' text-2xl font-bold text-center'>Play Gebeta and Games</h1>
        ...
        <div className="bt-right p-14 flex flex-col justify-center">
          <img className='rounded-[15px]' src={animals} alt="panda" />
        </div>
      </motion.div>
  )
}
